...
function loadMemberContent(memberID) {
    jQuery.ajax({
        ...
        success: function (html) {
            ...
            jQuery('html, body').animate({
                scrollTop: jQuery('#team-holder').offset().top - 150
            }, 400);
            setTimeout(function () {
                jQuery("#mcw-" + memberID).imagesLoaded(function () {
                    ...
                    jQuery('#team-holder .close-icon').on('click', function (e) {
                        ...
                        setTimeout(function () {
                            jQuery('html, body').animate({
                                scrollTop: jQuery('#team-member-' + memberReturnItemID).offset().top - 150
                            }, 400);
                        }, 500);
                    });
                });
...
function splitSectionTitleFix() {
    ...
    jQuery(".section-title-holder.portfolio-title-fix-class").stick_in_parent(({
            offset_top: 64,
            parent: ".section-wrapper",
            spacer: ".sticky-spacer"
        }))
